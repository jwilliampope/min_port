...
function Footer() {
  return (
    <div className="py-5 text-center">
      <div className="container max-w-screen-lg mx-auto">
        <div>
          <div className="flex flex-wrap justify-center gap-2">
            <a href="https://www.linkedin.com/in/jack-pope-3267a2203/" target="_blank" className="bg-stone-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
            ...
            <a href="https://github.com/jwilliampope?tab=repositories/" target="_blank" className="bg-stone-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
      ...
      <p className="text-sm mt-2  opacity-50">&copy; {new Date().getFullYear()} Jack Pope.</p>
    </div>
  )
}
